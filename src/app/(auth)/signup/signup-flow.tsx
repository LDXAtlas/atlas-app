...
export function SignupFlow() {
  ...
  const inputClasses =
    "rounded-full border border-border bg-surface px-4 py-3 text-foreground placeholder-muted outline-none transition-shadow duration-200 focus:border-mint focus:ring-1 focus:ring-mint focus:shadow-md focus:shadow-mint/10";
