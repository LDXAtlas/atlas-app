...
// Note: type re-exports from a "use server" file aren't reliably resolved
// by Next.js's RSC build, so client/UI code should import NotificationType
// and NotificationEntityType directly from "@/lib/notifications-config".
// This file uses them locally for parameter typing.
